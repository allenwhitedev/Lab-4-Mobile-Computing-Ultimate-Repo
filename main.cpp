...
#define BROKER "192.xxx.x.xxx"   // MQTT broker URL
#define PORT 1883                           // MQTT broker port number
#define CLIENTID "YOUR_MAC_ADDRESS"                         // use K64F MAC address without colons
...
//    data.password.cstring = PASSWORD;
    ...
    //char* topic = TOPIC;
    char* topic = "isThresholdExceeded";
    
    // subscribe to MQTT topic -> specifically isThresholdExceeded
